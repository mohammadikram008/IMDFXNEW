...
const Tablerecords = (props) => {
  ...
  const fetchAcceptedReq = async () => {
    try {
      // const response = await axios.post(`https://imdfx-newserver-production.up.railway.app/api/hospitalacceptedrequest/${userId}`);
      const response = await axios.get(`https://imdfx-newserver-production.up.railway.app/api/office-accepte-request/${doc_id}`);
      setAcceptedReq(response.data);
      console.log("setAcceptedReq", response.data)
      setLoading(false);
    } catch (error) {
  ...
  const fetchAllOffices = async () => {
    try {
      ...
      // console.log("setAllHospital", response.data);
      setLoading(false);
    } catch (error) {
      console.error('Error fetching Request:', error);
      setLoading(false);
  ...
  const handleChangeDelete = async (id) => {
    ...
    try {
      // const response = await axios.post(`https://imdfx-newserver-production.up.railway.app/api/hospitalacceptedrequest/${userId}`);
      const response = await axios.post(`https://imdfx-newserver-production.up.railway.app/api/delele-doctor-office/${id}`);
      // setAcceptedReq(response.data);
      // console.log("setAcceptedReq", response.data)
      setLoading(false);
    } catch (error) {
  ...
  const handleChangeSendRequest = async (Hos_Id) => {
    // console.log(Hos_Id);
    try {
      const response = await axios.post(`https://imdfx-newserver-production.up.railway.app/api/sendrequest/${doc_id}`, { Hos_Id });

      toast.success("Request has submited successful!");
              ...
              <nav className="user-tabs mb-4">
                <ul className="nav nav-tabs nav-tabs-bottom nav-justified">
                  ...
                  <li className="nav-item">
                    ...
                    // data-bs-toggle="tab"
                    >
                      {office && office ? "Your Office" : "offices"}
                    </p>
                  </li>
                </ul>
              </nav>
                                ...
                                <>
                                  {
                                    ...
                                    <span className="d-block text-info">
                                      ...
                                      <i className="fas fa-print" /> Print
                                            ...
                                            <button
                                              onClick={() => handleChangeDelete(item._id)}
                                              // to={{
                                              //   pathname: "/doctor/add-prescription",
                                              //   state: { item } // Replace with your actual data
                                              // }}
                                              // to="/doctor/add-prescription"
                                              className="btn btn-sm bg-danger">
                                              <i className="fas fa-pencil" /> Delete
                                            </button>
                                ...
                                <>
                                  {
                                    ...
                                    <span className="d-block text-info">
                                      ...
                                      <i className="fas fa-print" /> Print
                                            ...
                                            <button
                                              onClick={() => handleChangeSendRequest(item._id)}
                                              // to={{
                                              //   pathname: "/doctor/add-prescription",
                                              //   state: { item } // Replace with your actual data
                                              // }}
                                              // to="/doctor/add-prescription"
                                              className="btn btn-sm bg-success-light">
                                              <i className="fas fa-book" /> Send Request
                                            </button>
