...
const Tablerecords = () => {
  ...
  const fetchAppointments = async () => {
    try {
      const response = await axios.get(`https://imdfx-newserver-production.up.railway.app/api/appointment-details/${doc_Id}`);
                          ...
                          <tbody>
                            {
                              appointments.map((item, index) => (
                                <tr>
                                  <td>1</td>
                                  <td>
                                    {item.bookingDetail.selectedDate}{" "}
                                    <span className="d-block text-info">
                                      {item.bookingDetail.selectedTimeSlot}
                                    </span>
                                  </td>
                                  <td>Prescription</td>
                                  <td>
                                    <h2 className="table-avatar">
                                      ...
                                      <Link to="/patient/doctor-profile">
                                        {item.userDetail.username}<span>{item.userDetail.email}</span>
