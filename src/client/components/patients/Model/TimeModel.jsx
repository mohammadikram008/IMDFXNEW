...
const BookingModal = ({ showModal,handleModalClose,doctorDetail }) => {
  ...
  // };
    ...
    return (
        ...
        <div className={`modal model-time-slot  ${showModal ? 'show' : ''}`} tabIndex="-1" role="dialog" style={{ display: showModal ? 'block' : 'none' }}>
