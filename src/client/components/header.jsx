                ...
                >
                      ...
                      <li>
                        <div className="megamenu-wrapper">
                          <div className="row">
                            ...
                            <div className="col-lg-2">
                              <div
                                className={`single-demo ${pathnames.includes("/index-9") ? "active" : ""
                                  }`}
                              >
                                <div className="demo-img">
                                  <Link
                            ...
                            <div className="col-lg-2">
                              <div
                                className={`single-demo ${pathnames.includes("/index-10")
                                    ? "active"
                                    : ""
                                  }`}
                              >
                            ...
                            <div className="col-lg-2">
                              <div
                                className={`single-demo ${pathnames.includes("/index-11")
                                    ? "active"
                                    : ""
                                  }`}
                              >
                            ...
                            <div className="col-lg-2">
                              <div
                                className={`single-demo ${pathnames.includes("/index-12")
                                    ? "active"
                                    : ""
                                  }`}
                              >
                            ...
                            <div className="col-lg-2">
                              <div
                                className={`single-demo ${pathnames.includes("/index-13")
                                    ? "active"
                                    : ""
                                  }`}
                              >
                  ...
                  >
                    ...
                    {isSideMenu == "pages" ? (
                      ...
                      >
                        ...
                        <li
                          className={`has-submenu ${pathnames.includes("/authentication")
                            ? "active"
                            : ""
                            }`}
                        >
                  ...
                  {/* <li className="has-submenu">
                    <Link
                      to="#"
                      // target="_blank"
                      className={isSideMenu == "admin" ? "subdrop" : "text-white"}
                      onMouseEnter={() =>
                        toggleSidebar(
                        ...
                        !pathnames.includes("/index-11") && (
                          ...
                          <>
                            ...
                            <li className="register-btn">
                              <Link to={`${token?"/patient/dashboard":"/register"}`} className="btn reg-btn">
                                <i>
